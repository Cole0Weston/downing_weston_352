...
Observer - Both the ProficiencyObserver and AbilityObserver classes are implementations of the Observer pattern, used to keep ability bonuses, skill values, and so forth in sync.
