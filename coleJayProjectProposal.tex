...
\includegraphics[scale=.15]{chrSheet.jpg}
...
\begin{figure}[h]
\includegraphics[scale=.4]{interface-mockup.png}
\caption{Potential Interface}
\label{CharacterSheetPage}
\end{figure}
...
\texttt{
\begin{figure}[h!]
\includegraphics[scale=.4]{ProjectUML.png}
\caption{Project UML}
\label{CharacterSheet}
\end{figure}
}
